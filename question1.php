...
<html lang="en" >
    ...
    <head>
        ...
        <meta charset="UTF-8">
        <meta http-equiv="refresh" content="10;url=question1.php" />
    ...
    <body onload="startDictation()">
        <div style="display: none">
            <iframe  src="sounds/question1.mp3" allow="autoplay"  id="iframeAudio"></iframe>
            <audio autoplay loop  id="playAudio">
                <source src="sounds/question1.mp3">
            </audio>
